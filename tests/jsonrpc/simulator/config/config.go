...
type Config struct {
	EvmdHttpEndpoint string `yaml:"roon_http_endpoint"`
	EvmdWsEndpoint   string `yaml:"roon_ws_endpoint"`
...
func MustLoadConfig() *Config {
	...
	roonURL := os.Getenv("EVMD_URL")
	if roonURL == "" {
		roonURL = EvmdHttpEndpoint
	}
	...
	roonWsURL := os.Getenv("EVMD_WS_URL")
	if roonWsURL == "" {
		roonWsURL = EvmdWsEndpoint
	}
	...
	return &Config{
		EvmdHttpEndpoint: roonURL,
		EvmdWsEndpoint:   roonWsURL,
