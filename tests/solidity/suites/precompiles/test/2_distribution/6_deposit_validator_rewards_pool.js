...
describe('Distribution – deposit validator rewards pool', function () {
    ...
    it('deposits rewards and emits DepositValidatorRewardsPool event', async function () {
        ...
        const VAL_BECH32 = await hexToBech32Addr(hre, valHexAddrs[0], 'roonvaloper');
        const VAL_HEX = valHexAddrs[0];
        const coin = { denom: 'aroon', amount: hre.ethers.parseEther('0.1') };
